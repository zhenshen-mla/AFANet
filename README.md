...
## Models
  * model/pixel_single.py & image_single.py: single task baseline   
  * model/pixel_hard.py & image_hard.py: parameters hard sharing baseline   
  * model/pixel_cross.py & image_cross.py: cross stitch baseline   
  * model/pixel_nddr.py & image_nddr.py: nddr-cnn baseline   
  * model/pixel_AFA.py & image_AFA.py: our method   
